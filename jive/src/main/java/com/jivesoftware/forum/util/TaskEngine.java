...
import java.util.*;
import com.jivesoftware.util.Timer;
...
public class TaskEngine {
    ...
    static {
        ...
        taskTimer = new com.jivesoftware.util.Timer(true);
     ...
     */
    public static TimerTask scheduleTask(Runnable task, long delay,
            long period)
    {
     ...
     *      task and to cancel subsequent executions.
     */
    public static TimerTask scheduleTask(Runnable task, int priority,
