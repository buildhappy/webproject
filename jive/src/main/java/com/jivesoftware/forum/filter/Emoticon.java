 ...
 *     <tr><td>Confused</td><td>?:|</td><td>consused.gif</td></tr>
 ...
 * of this filter.
 */
public class Emoticon extends ForumMessageFilter {
    ...
    /**
     * <b>Overloaded</b> to return the subject of the message with ASCII emoticons
     * translated to images.
     *
     * @return the subject of the message with emoticon tokens replaced by images.
     */
    public String getSubject() {
        if (filteringSubject) {
            return convertEmoticons(message.getSubject());
        }
        else {
    ...
    /**
     * <b>Overloaded</b> to return the body of the message with ASCII emoticons
     * translated to images.
     *
     * @return the body of the message with emoticon tokens replaced by images.
     */
    public String getBody() {
        if (filteringBody) {
            return convertEmoticons(message.getBody());
        }
        else {
