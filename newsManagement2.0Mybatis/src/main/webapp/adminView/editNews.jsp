...
<body>
	...
	<div>
		<form action="<%=request.getContextPath()%>/AdminService"
			method="post" style="width: 1024px; height: 500px;">

			标题：<input type="text" name="title" />
			<!-- 类型选择 -->
			<select name="type">
				<option selected="" vaule="society">社会</option>
				<option vaule="technology">科技</option>
				<option vaule="military">军事</option>
				<option vaule="sport">体育</option>
				<option vaule="finance">财经</option>
			</select>
